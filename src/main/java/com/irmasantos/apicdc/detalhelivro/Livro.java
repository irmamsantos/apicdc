...
//	}
	...
	public String toString() {
		return "Livro [id=" + id + ", titulo=" + titulo + ", subTitulo=" + subTitulo + ", preco=" + preco
				+ ", conteudo=" + conteudo + ", sumario=" + sumario + ", numeroPaginas=" + numeroPaginas + ", isbn="
				+ isbn + ", linkCapaLivro=" + /*linkCapaLivro*/ "" + ", autor=" + autor + "]";
	}
}

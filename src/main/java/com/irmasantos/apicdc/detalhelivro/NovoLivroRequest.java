...
public class NovoLivroRequest {
	...
	public Livro novoLivro(AutorRepository autorRepository, /*Function<MultipartFile, String> funcaoFazUpload*/ Uploader uploader) {
		Autor autor = autorRepository.findById(autorId).get();
		String linkCapaLivro = /*funcaoFazUpload.apply(capa)*/ uploader.upload(capa);
